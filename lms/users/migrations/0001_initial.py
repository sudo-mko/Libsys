    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('member', 'Library Member'), ('librarian', 'Librarian'), ('manager', 'Library Manager'), ('admin', 'Admin')], default='member', max_length=20)),
                ...
                ('membership', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.membershiptype')),
            ],
            options={
                'verbose_name': 'user',
